...
public class FilaAtendimentoTest {
	...
	public void adicionaItemLista() {
		...
		Paciente paciente1 = new Paciente("teste1",28,Prioridade.VERDE);
		Paciente paciente2 = new Paciente("teste2",28,Prioridade.VERMELHA);
		Paciente paciente3 = new Paciente("teste3",28,Prioridade.AMARELA);
		Paciente paciente4 = new Paciente("teste4",28,Prioridade.VERDE);
		Paciente paciente5 = new Paciente("teste5",28,Prioridade.AMARELA);
